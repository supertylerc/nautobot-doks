...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "@pp$s=tme^evc9qgo&_c#h0^fo-l$adee-zqw5=x_s)9f=$qdm")
...
# TC: Begin customizations for enabling SSL for Redis and PostgreSQL.
#     Everything prior to this is simply a copy of the default file from
#     the chart, obtained with the following command:
#       kubectl cp nautobot-6b9975cfb-cp9ht:/opt/nautobot/nautobot_config.py ./nautobot_config.py
